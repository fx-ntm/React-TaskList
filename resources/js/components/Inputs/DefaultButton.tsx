 ...
 * />
 */
export default function DefaultButton({ label, color, functionDestination }: ButtonProps) {
    /**
    ...
    return (
        <button className={`rounded bg-blue-600 px-4 py-2 text-white transition-colors ${color ? buttonColor : 'bg-blue-600'}`} onClick={functionDestination}>
            <p>{label}</p>
        </button>
    );
}
